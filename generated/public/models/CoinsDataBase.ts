...
/**
 * Check if a given object implements the CoinsDataBase interface.
 */
export function instanceOfCoinsDataBase(value: object): value is CoinsDataBase {
    return true;
}

export function CoinsDataBaseFromJSON(json: any): CoinsDataBase {
    return CoinsDataBaseFromJSONTyped(json, false);
}

export function CoinsDataBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CoinsDataBase {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function CoinsDataBaseToJSON(json: any): CoinsDataBase {
      return CoinsDataBaseToJSONTyped(json, false);
  }

  export function CoinsDataBaseToJSONTyped(value?: CoinsDataBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
